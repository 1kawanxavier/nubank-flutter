...
class _HeaderState extends State<Header> {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(80), color: secondaryPuple
        ),
        child: IconButton(
          onPressed: (){},
          icon: Icon(
  ...
  _welcome(){
    return Container(
      ...
      child: const Text("Olá, Kawan", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
    );
  }
}